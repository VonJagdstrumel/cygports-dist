...
|`idle311`|Python 3.11 Tkinter-based IDE|`Python`, `Interpreters`|`3.11.9-1`, `3.11.2-1`|
|`idle313`|Python 3.13 Tkinter-based IDE|`Python`, `Interpreters`|`3.13.0b1-1`|
|`innoextract`||`Archive`, `Utils`|`1.9-1`|
|`jemalloc`||`Devel`|`5.3.0-1`|
|`jpegoptim`||`Graphics`, `Utils`|`1.5.5-1`|
|`liquidprompt`||`Shells`|`2.2.0.rc2-1`|
|`luarocks`||`Lua`|`3.11.0-1`|
|`mawk`||`Interpreters`|`1.3.4.20240123-1`|
|`mimalloc`||`Devel`|`2.1.5-1`|
|`mozjpeg`||`Devel`|`4.1.5-1`|
|`nanomsg`||`Devel`|`1.2.1-1`|
|`nq`||`Utils`|`0.5-1`|
|`parallel`||`Utils`|`20240422-1`|
...
|`python3-pip`|Python package installation tool|`Python`, `Virtual`|`24.0-2`|
|`python311`|Py3K language interpreter|`Python`, `Interpreters`|`3.11.9-1`, `3.11.2-1`|
|`python311-asn1crypto`|Python ASN.1 library|`Python`|`0.24.0-1`|
...
|`python311-debuginfo`|Debug info for python311|`Debug`|`3.11.9-1`, `3.11.2-1`|
|`python311-devel`|Py3K language interpreter|`Python`, `Interpreters`|`3.11.9-1`, `3.11.2-1`|
...
|`python311-pip`|Python package installation tool|`Python`|`24.0-2`|
...
|`python311-test`|Py3K tests|`Python`, `Interpreters`|`3.11.9-1`, `3.11.2-1`|
|`python311-tkinter`|Py3K Tkinter GUI module|`Python`, `Interpreters`|`3.11.9-1`, `3.11.2-1`|
|`python311-wheel`|Python package format module|`Python`|`0.43.0-1`|
|`python313`|Py3K language interpreter|`Python`, `Interpreters`|`3.13.0b1-1`|
...
|`python313-debuginfo`|Debug info for python313|`Debug`|`3.13.0b1-1`|
|`python313-devel`|Py3K language interpreter|`Python`, `Interpreters`|`3.13.0b1-1`|
...
|`python313-pip`|Python package installation tool|`Python`|`24.0-2`|
|`python313-ply`|Python lex and yacc|`Python`|`3.11-1`|
|`python313-pycparser`|Python C language parser|`Python`|`2.22-1`|
|`python313-setuptools`|Python package management tool|`Python`|`69.5.1-1`|
|`python313-six`|Python 2 and 3 compatibility library|`Python`|`1.12.0-1`|
|`python313-test`|Py3K tests|`Python`, `Interpreters`|`3.13.0b1-1`|
|`python313-tkinter`|Py3K Tkinter GUI module|`Python`, `Interpreters`|`3.13.0b1-1`|
...
|`python39-pip`|Python package installation tool|`Python`|`24.0-2`|
